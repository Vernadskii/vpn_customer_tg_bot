...
from telegram_bot.handlers.location.static_text import share_location, thanks_for_location
from telegram_bot.handlers.location.keyboards import send_location_keyboard
